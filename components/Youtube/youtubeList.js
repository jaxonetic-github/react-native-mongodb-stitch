...
class YouTubeList extends React.Component {
    constructor(props) {
    super(props);
console.log("YouTubeList*************************",props.navigation.state.params);
    //setting default state
    if(this.props.navigation.state.params && this.props.navigation.state.params.record)
    //setting default state
    this.state = { dataArray: this.props.navigation.state.params.record.payload.items, text: '',name:props.title, baseURL:props.url};
    else
   

    this.state = {dataArray:null, name:props.title, baseURL:props.url};
  }
