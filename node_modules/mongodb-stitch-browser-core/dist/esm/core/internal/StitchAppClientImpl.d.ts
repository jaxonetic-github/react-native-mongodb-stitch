...
export default class StitchAppClientImpl implements StitchAppClient, StitchAuthListener {
    ...
    onActiveUserChanged(_: StitchAuth, currentActiveUser: StitchUser | undefined, previousActiveUser: StitchUser | undefined): void;
    private bindServiceClient;
    private onRebindEvent;
}
