...
<html lang="en">
<head>
    <title>Code coverage report for src/__tests__/utils.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/__tests__</a> utils.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">8x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* @noflow */
&nbsp;
