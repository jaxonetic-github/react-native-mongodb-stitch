...
<html lang="en">
<head>
    <title>Code coverage report for src/CardStack.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> CardStack.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >    BackHandler.removeEventListener('hardwareBackPress', this.onNavigateBack)</span>
  }
&nbsp;
  componentWillReceiveProps(nextProps: Props) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (nextCards &amp;&amp; !StackUtils.shallowEqual(cards, nextCards)) {
...
<span class="cstat-no" title="statement not covered" >          break</span>
        ...
        case 'POP': {
          const n = <span class="cstat-no" title="statement not covered" >index - nextIndex</span>
<span class="cstat-no" title="statement not covered" >          this.setState(<span class="fstat-no" title="function not covered" >pr</span>evState =&gt; (<span class="cstat-no" title="statement not covered" >{</span></span>
...
&nbsp;
  onNavigateBack = () =&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.state.navigationState.index &gt; 0) {
...
<span class="branch-1 cbranch-no" title="branch not covered" >      this.state.navigationState !== nextState.navigationState</span>
    )
  }
&nbsp;
