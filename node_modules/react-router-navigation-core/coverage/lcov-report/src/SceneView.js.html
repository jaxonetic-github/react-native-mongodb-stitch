...
<html lang="en">
<head>
    <title>Code coverage report for src/SceneView.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> SceneView.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >    if (this.unlisten) <span class="cstat-no" title="statement not covered" >this.unlisten()</span></span>
  }
&nbsp;
...
&nbsp;
  render() {
    ...
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (children &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof children === 'function')</span> {
<span class="cstat-no" title="statement not covered" >      return children(contextRouter)</span>
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (children &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >React.Children.count(children) === 0)</span> {
<span class="cstat-no" title="statement not covered" >      return React.cloneElement(children, contextRouter)</span>
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (Component) {
      return (
        &lt;Component
